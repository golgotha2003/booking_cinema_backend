...
public class GlobalExceptionHandler {
        ...
        @ApiResponse(
            ...
            content={@Content(mediaType=APPLICATION_JSON_VALUE,
                examples=@ExampleObject(
                    name="Handle exception when the data invalid. (@RequestBody, @PathVariable, @RequestParam)",
    ...
    /**
     * Handle exception then the request not found data
     * 
     * @param e
     * @param request
     * @return errorResponse
    ...
    /**
     * Handle exception then the data is conflicted
     * 
     * @param e
     * @param request
     * @return errorResponse
    ...
    /**
     * Handle exception then internal server error
     * 
     * @param e
     * @param request
     * @return errorResponse
